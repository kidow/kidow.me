import { Comment, Card, Icon, Required, ColorPicker } from 'components'
...
- https://github.com/ScottSavarie/react-canvas-color-picker
- https://codepen.io/pizza3/pen/BVzYNP?editors=0110

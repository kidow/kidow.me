...
date: 2022-06-15
description: When I was new to frontend and started React, the first css library I encountered was styled-components.
...
<Figure
  caption="TailwindCSS 홈페이지"
  image="https://files.kidow.me/image/tailwindcss.gif"
/>
...
<Figure image="https://files.kidow.me/image/animate-bounce.gif" />
...
<Figure
  ...
  image="/contents/5/developer-tools.png"
/>

<Figure caption="검색하면 바로 나온다." image="/contents/5/search.png" />

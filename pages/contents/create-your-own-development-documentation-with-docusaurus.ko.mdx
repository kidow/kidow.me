...
<Figure caption="Docusaurus 소개" image="/contents/8/docusaurus.png" />
...
<Figure caption="archive.kidow.me 소개 페이지" image="/contents/8/intro.png" />
...
<Figure caption="Button 컴포넌트" image="/contents/8/button.png" />
...
<Figure
  ...
  image="/contents/8/prerequisite.png"
/>
...
<Figure caption="Modal 컴포넌트 Props" image="/contents/8/modal.png" />

넘겨줄 수 있는 속성들입니다. 필수 값 여부도 구분하면 좋을 것 같아서 구분을 한 번 해봤습니다니.

#### Usage

<Figure caption="Toast 컴포넌트 Usage" image="/contents/8/toast.png" />
...
<Figure caption="Hooks / Utils / Settings" image="/contents/8/rest.png" />

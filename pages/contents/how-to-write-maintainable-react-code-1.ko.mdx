...
<Figure caption="코드 스니펫(exp)" image="/contents/2/exp.gif" />

제가 쓰는 코드 스니펫들은 [이 곳](https://kidow.me/archive/settings/CodeSnippets)에 정리해놓았습니다.
...
<Figure caption="option(alt) + 클릭" image="/contents/2/option_click.gif" />

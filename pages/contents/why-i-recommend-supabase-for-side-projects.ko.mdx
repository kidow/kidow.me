...
<Figure caption="Supabase" image="/contents/13/supabase.png" />
...
<Figure
  ...
  image="/contents/13/ranking.png"
/>

### 무료 플랜이 사이드 프로젝트를 런칭하기에 매우 충분하다

<Figure caption="Supabase 가격 정책" image="/contents/13/pricing.png" />
...
<Figure caption="Unlimited API Request" image="/contents/13/database.png" />
...
<Figure
  ...
  image="/contents/13/rds.png"
/>

### 스토리지의 경우 조회 당 비용을 받지 않는다

<Figure caption='출처: 유튜브 "노마드코더"' image="/contents/13/storage.png" />

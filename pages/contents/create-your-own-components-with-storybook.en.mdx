...
date: 2022-06-28
description: I write down the code of my own components in the code archive, but I can't tell exactly what this component looks like just by looking at the code.
...
<Figure caption="직접 만든 Modal 컴포넌트" image="/contents/8/components.png" />
...
<Figure caption="오른쪽의 Create React App 선택" image="/contents/8/cra.png" />

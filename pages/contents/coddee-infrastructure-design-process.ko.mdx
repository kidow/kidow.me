...
<Figure caption="Supabase 홈" image="/contents/18/main.png" />

Supabase는 Baas(Baekend as a service) 중 하나로, 구글의 유명한 Firebase에서 영감을 받아 대체제로서 역할을 하고자 시작된 오픈소스 프로젝트입니다.

<Figure caption="19년 10월부터 시작" image="/contents/18/first.png" />
...
<Figure image="/contents/18/series.png" />
...
<Figure caption="대시보드 홈" image="/contents/18/dashboard.png" />
...
<Figure caption="Coddee 프로젝트 홈" image="/contents/18/coddee.png" />
...
<Figure caption="10개의 테이블" image="/contents/18/table.png" />
...
<Figure
  ...
  image="/contents/18/sql-editor.png"
/>
...
<Figure
  ...
  image="/contents/18/replication.png"
/>
